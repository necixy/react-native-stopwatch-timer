...
class StopWatch extends Component {
  ...
  formatTime() {
    ...
    if (typeof this.props.getTimeInSecs === "function")
      this.props.getTimeInSecs(Math.floor(now / 1000));

    if (typeof this.props.getTimeInMSecs === "function")
      this.props.getTimeInMSecs(now);
